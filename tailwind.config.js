...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        h1: ['clamp(3.5rem, 14vw, 14rem)', { lineHeight: '0.85', letterSpacing: '-0.02em' }],
        'h1-2': ['clamp(2.75rem, 11vw, 11rem)', { lineHeight: '0.85', letterSpacing: '-0.02em' }],
        h2: ['clamp(2rem, 6vw, 5rem)', { lineHeight: '0.95' }],
        menu: ['clamp(3rem, 12vw, 12rem)', { lineHeight: '0.85', letterSpacing: '-0.02em' }],
